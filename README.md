...
cells, the profile you write in Part 6, and the disclosure cell at the end.

## Get your own copy

The course hub is one page that hands out the starter repositories. Open it,
https://classroom-hub.oleh-omelchenko.workers.dev, sign in with GitHub, and click
**Accept** next to *week2-practice*. You get your own private copy and its address.
...
[Week 1 setup check](https://github.com/stat163-2026t1/week1-setup-check) verifies both.
...
Two files in `data/`. The shop named them after two years; whether that describes what
they hold is one of the things the notebook asks you to check. `data/README.md` names the
...
Then paste your repository URL into the Week 2 practice assignment on Moodle. The deadline
